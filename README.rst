...
The current release of `django-crispy-forms` (1.8.1) supports Python 2.7/Python 3.5+ and Django 1.11, 2.1, 2.2 and 3.0. Following the release of Django 3.0 the next version of `django-crispy-forms` will drop support for all versions of Django prior to 2.2.
